    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "photo",
                    models.CharField(max_length=200, verbose_name="Фото file_id"),
                ),
                (
                    "price",
                    models.DecimalField(
                ...
                (
                    "category_code",
                    models.CharField(max_length=20, verbose_name="Код категории"),
                ),
                (
                    "category_name",
                ...
                (
                    "subcategory_code",
                    models.CharField(max_length=20, verbose_name="Код подкатегории"),
                ),
                (
                    "subcategory_name",
                    models.CharField(
                        max_length=20, verbose_name="Название подкатегории"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    jsonfield.fields.JSONField(
                        null=True, verbose_name="Адрес доставки"
                    ),
                ),
                (
                    "phone_number",
                ...
                (
                    "email",
                    models.EmailField(max_length=100, null=True, verbose_name="Email"),
                ),
                (
                    "receiver",
                    models.CharField(
                        max_length=100, null=True, verbose_name="Имя получателя"
                    ),
                ),
                (
                    "successful",
